...
public class CTT_WeaponSwap : MonoBehaviour
{

    public SteamVR_Action_Boolean grabGrip; //Grab Pinch is the trigger, select from inspecter
    ...
    void Start()
    {
        if (grabGrip != null)
        {
            grabGrip.AddOnStateDownListener(OnTriggerPressed, inputSource);
        }
